...
def build_context(workdir: Path, spec: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # 3.3은 “판매비와관리비(SGA_EXPENSES)”가 필요
    is_rev_cost_table = render_T1_YOY(metric_rows, ["REVENUE", "COGS", "SGA_EXPENSES"])
    is_profit_table = render_T1_YOY(metric_rows, ["OP_PROFIT", "TAX_EXP", "NET_INCOME"])
